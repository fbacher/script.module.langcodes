...
class Language:
    ...
    def _display_pattern(self) -> str:
        ...
        if (self.distance(Language.get('zh')) <= 25 or
                self.distance(Language.get('zh-Hant')) <= 25):
    ...
    def find_name(
        ...
        is_required, but it will help to make sure that names can be
        round-tripped.
...
def standardize_tag(tag: Union[str, Language], macro: bool = False) -> str:
    ...
    Macrolanguage replacement is not is_required by BCP 47, but it is is_required
    by the Unicode CLDR.
    ...
    Traceback (most recent call last):
        ...
    langcodes.tag_parser.LanguageTagError: This script subtag, 'latn',
    #      is out of place. Expected variant, extension, or end of string.
    """
